...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('celluleId', celluleId));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RequestAuthenProfileUpdateZone&&(identical(other.celluleId, celluleId) || other.celluleId == celluleId));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'RequestAuthenProfileUpdateZone(celluleId: $celluleId)';
}
...
class _RequestAuthenProfileUpdateZone with DiagnosticableTreeMixin implements RequestAuthenProfileUpdateZone {
   _RequestAuthenProfileUpdateZone({required this.celluleId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RequestAuthenProfileUpdateZone&&(identical(other.celluleId, celluleId) || other.celluleId == celluleId));
}
