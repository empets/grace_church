                      ...
                      if (rapportListState.data.isEmpty) {
                        return Container(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              SvgPicture.asset(assets.images.rapportEmpty.path, height: 0.2.sh,),
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      if (rapport.formSuggestionIsSubmit.contains("Success")) {
                                            
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => RapportCellulePDFView(rapportCellule: rapport),
                                              ),
                                            );
                                      }
                                       if (!rapport.formSuggestionIsSubmit.contains("Success")) {
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                  "Rapport ${rapport.formSuggestionIsSubmit.contains("Success") ? "terminé voir les détails" : "en cours"}",
                                                  style: context.appTypographie.body
                                                      .copyWith(
                                                        fontSize: 12.sp,
                                                        color: context
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: rapport.formSuggestionIsSubmit.contains("Success")?  Icon(Icons.lock_open, size: 12, color: Colors.white)
