...
@lazySingleton
class SendRapportCelluleStepAdministrationUsercase
    implements UseCase<String, RequestRapportCelluleAdministration> {
  SendRapportCelluleStepAdministrationUsercase(this.repository);
  final CelluleRepositoriesDomaine repository;
  @override
  Future<Either<Failure, String>> call(
    RequestRapportCelluleAdministration params,
  ) {
    return repository.sendRapportCelluleStepAdministration(params);
  }
}
